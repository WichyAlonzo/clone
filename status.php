              ...
              <div class="grid-reactions">
                ...
                <div class="grid-box-reaction">
                  ...
                  <div class="hover-reaction hover-reaction-retweet
                    ...
                    " data-retweeted="<?php echo $user_retweeted_it; ?>" data-sign="<?php echo $retweet_sign; ?>" data-tmp="<?php echo $retweet_comment; ?>" data-qoq="<?php echo $qoq; ?>" data-status="<?php echo true; ?>">
